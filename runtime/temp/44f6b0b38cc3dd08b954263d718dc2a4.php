<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpstudy\WWW\dy\public/../application/index\view\task\task_kol.html";i:1574599168;}*/ ?>
<!DOCTYPE html>
					...
					[ //表头
						{
							...
							align: 'center',
							templet: function(d) {
								return '<a href="javascaript:;" onclick="xadmin.open(\'编辑大号\',\'/index/Task/taskKolEdit?task_kol_id=' +d.task_kol_id + '\',500,270);"><i class="iconfont">&#xe69e;</i></a>';
							}
						}
					]
				]
