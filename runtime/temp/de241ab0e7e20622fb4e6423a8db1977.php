<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\phpStudy\WWW\dy\public/../application/index\view\user\main.html";i:1576681962;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
	...
	<body class="index">
		...
		<div class="container">
			<div class="logo">
				<a href="/main"><img src="../../static/images/logo.png" width="40" height="40">后台管理系统</a></div>
			<div class="left_open">
				...
				<ul id="nav">
					<li>
						...
						<ul class="sub-menu">
							...
							<li>
								<a onclick="xadmin.add_tab('租车管理','/index/Rent/index')">
									<i class="iconfont">&#xe6b5;</i>
									<cite>车辆管理</cite>
								</a>
							</li>
