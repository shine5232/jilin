<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpstudy\WWW\dy\public/../application/index\view\task\task_kol_edit.html";i:1574598515;}*/ ?>
<!DOCTYPE html>
						...
						<div class="layui-card-body ">
							<form class="layui-form layui-col-space5">
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<select name="task_id" id="task_id" class="layui-select">
											...
											<option value="<?php echo $l['task_id']; ?>" <?php if($l['task_id'] == $task_kol['task_id']): ?>selected<?php endif; ?>><?php echo $l['task_name']; ?></option>
								...
								<div class="layui-form-item layui-form-text">
									...
									<div class="layui-input-block">
										<textarea name="third_party_id" class="layui-textarea" required lay-verify="required"><?php echo $task_kol['third_party_id']; ?></textarea>
								...
								<div class="layui-form-item layui-form-text">
									...
									<div class="layui-input-block">
										<textarea name="nickname" class="layui-textarea" required lay-verify="required"><?php echo $task_kol['nickname']; ?></textarea>
										<div class="layui-form-mid layui-word-aux">
											不超过1000字符
										</div>
									</div>
